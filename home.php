...
<body class="bg-gray-100">
    ...
    <header class="bg-white shadow">
        <div class="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
            ...
            <div class="flex items-center space-x-4">
                <button onclick="loadUsers()" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg font-semibold transition duration-200">
                    👥 View All Users
                </button>
                <button onclick="showModal('addUserModal')" class="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-lg font-semibold transition duration-200">
                    ➕ Add User
                </button>
                <div class="relative">
                    <button onclick="toggleUserMenu()" class="bg-purple-500 hover:bg-purple-600 text-white px-4 py-2 rounded-lg font-semibold transition duration-200">
                        👤 Profile
                    </button>
    ...
    <!-- Users Modal -->
    <div id="usersModal" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center">
